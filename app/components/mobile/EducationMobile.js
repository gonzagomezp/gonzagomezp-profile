    ...
    <div className="px-4 py-6">
      ...
      <div className="space-y-4">
        <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-200">
          <div className="text-lg font-semibold text-green-600 mb-2">Bachelor's in Systems Engineering</div>
          <div className="text-sm text-gray-500 mb-3">Universidad Católica de Córdoba • 2021 - December 2025</div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-200">
          <div className="text-lg font-semibold text-green-600 mb-2">High School with Intensive English</div>
          <div className="text-sm text-gray-500 mb-3">Instituto María de Nazareth • Completed</div>
          <div className="text-sm text-gray-600 space-y-1">
        ...
        <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-200">
          <div className="text-lg font-semibold text-green-600 mb-3 text-center">Continuous Learning</div>
