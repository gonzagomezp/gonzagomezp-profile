    ...
    <div className="px-4 py-6">
      ...
      <div className="space-y-4">
        <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-200">
          <div className="text-lg font-semibold text-blue-600 mb-2">Full Stack Intern</div>
          <div className="text-sm text-gray-500 mb-3">Bircle AI, Argentina • March 2024 - November 2024</div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-200">
          <div className="text-lg font-semibold text-blue-600 mb-2">Ski Equipment Rental</div>
          <div className="text-sm text-gray-500 mb-3">Vail Resorts, USA • Winter 2022/23</div>
          <div className="text-sm text-gray-600 space-y-1">
        ...
        <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-200">
          <div className="text-lg font-semibold text-blue-600 mb-2">Junior Trader</div>
          <div className="text-sm text-gray-500 mb-3">Argentina Valores S.A. • Dec 2020 - July 2021</div>
          <div className="text-sm text-gray-600 space-y-1">
