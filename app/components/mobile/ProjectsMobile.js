    ...
    <div className="px-4 py-6 bg-gray-900">
      ...
      <div className="space-y-4">
        <div className="bg-gray-800 rounded-xl p-4 shadow-lg">
          <div className="text-lg font-semibold text-purple-400 mb-2">Cantina UCC - Final University Project</div>
          <div className="text-sm text-gray-400 mb-3">December 2024 - Present</div>
          ...
          <div className="flex flex-wrap gap-1">
            {['FastAPI', 'Next.js', 'Firestore', 'Docker', 'GCP'].map((tech) => (
              <span key={tech} className="px-2 py-1 bg-purple-900 text-purple-300 text-xs rounded-full">
                {tech}
              </span>
            ))}
          </div>
        ...
        <div className="bg-gray-800 rounded-xl p-4 shadow-lg">
          <div className="text-lg font-semibold text-purple-400 mb-2">Academic Projects</div>
          <div className="text-sm text-gray-400 mb-3">Universidad Católica de Córdoba - 2021-2025</div>
          <div className="text-sm text-gray-300 space-y-1 mb-3">
