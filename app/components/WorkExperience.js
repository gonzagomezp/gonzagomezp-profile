    ...
    <div className="text-left">
      ...
      <div className="space-y-8">
        <div className="bg-green-950 border border-green-600 p-6 rounded-lg">
          ...
          <div className="text-[50px] text-green-300 mb-2">Bircle AI, Argentina • March 2024 - November 2024</div>
        ...
        <div className="bg-green-950 border border-green-600 p-6 rounded-lg">
          ...
          <div className="text-[50px] text-green-300 mb-2">Vail Resorts, USA • Winter 2022/23</div>
          <div className="text-[50px] text-green-500 space-y-2">
        ...
        <div className="bg-green-950 border border-green-600 p-6 rounded-lg">
          ...
          <div className="text-[50px] text-green-300 mb-2">Argentina Valores S.A. • December 2020 - July 2021</div>
          <div className="text-[50px] text-green-500 space-y-2">
